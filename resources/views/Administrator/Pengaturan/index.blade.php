                        ...
                        <div class="card-header">
                            <div class="d-flex flex-column flex-sm-row align-items-center">
                                ...
                                <div class="flex-grow-1 mx-5 text-center text-sm-start">
                                    ...
                                    <p class="mb-0"><i class="fa-solid fa-location-dot me-2"></i>8534 Saunders Hill Apt. 583</p>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row g-4">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-5">
                                                        <div class="form-floating mb-0">
                                                            <input type="text" class="form-control" id="keteranganHakCipta"
                                                                placeholder="" value="01267766" />
                                            ...
                                            <div class="mb-5">
                                                <div class="form-floating mb-0">
                                                    <input type="text" class="form-control" id="urlOss"
                                                        placeholder="Masukkan url" value="https://oss.go.id/informasi/kbli-detail/640d2ba5-b059-4ce0-9324-ec17c5df4a12" />
                                ...
                                <div class="card mt-4 shadow-none border mb-0 h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="form-check form-switch custom-switch-v1 switch-lg mb-4">
                                            <input type="checkbox" class="form-check-input input-primary f-16"
                                                id="shareActive" />
                                            <label class="form-check-label" for="shareActive">Aktifkan Berbagi Data</label>
                                        </div>
                                        <div id="form-akun-oss" style="display: none;">
                                            <div class="row g-4">
                                                <div class="col-md-6">
