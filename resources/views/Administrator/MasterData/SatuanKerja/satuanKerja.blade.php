        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="p-3">
                    ...
                    <!-- Baris pertama: Nama Instansi, Instansi -->
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="namaInstansi" placeholder="Nama Instansi" />
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="kewenanganLayanan" placeholder="Kewenangan Layanan" />
