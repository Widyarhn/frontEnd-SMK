@extends('...Internal.index', ['title' => 'Pengaturan Akun | Pengaturan'])
@section('asset_css')
                        ...
                        <div class="col-lg-4 col-xxl-3">
                            <div class="card">
                                <div class="card-body position-relative">
                                    <div class="position-absolute end-0 top-0 p-3"><span class="badge bg-success">Aktif</span>
                                    </div>
                                    <div class="text-center mt-3">
                                        ...
                                        <h5 class="mb-0">Sammy</h5>
                                        <p class="text-muted text-sm">Sam Hilbert</p>
                                        <hr class="my-3 border border-secondary-subtle">
                                        <div class="row g-3">
                                            <div class="col-6">
                                                <h5 class="mb-0">NIP</h5><small class="text-muted">0000000000000001</small>
                                            </div>
                                            <div class="col-6 border border-top-0 border-bottom-0" style="border-right: 0 !important;">
                                                <h5 class="mb-0">Peran</h5><small class="text-muted">Penilai</small>
                                            </div>
                                        </div>
                                        <hr class="my-3 border border-secondary-subtle">
                                        <div class="d-inline-flex align-items-center justify-content-start w-100 mb-3"><i
                                                class="ti ti-mail me-2"></i>
                                            <p class="mb-0">sammy@gmail.com</p>
                                        </div>
                                        <div class="d-inline-flex align-items-center justify-content-start w-100 mb-3">
                                            <i class="fa-regular fa-calendar-days me-2"></i>
                                            <p class="mb-0">Terdaftar : 2024-12-07 00:11:55</p>
                                        </div>
